...
class pn_feat(nn.Module):
    def __init__(self, args, flag_global_feat=True):
        ...
        self.conv5 = nn.Sequential(
            ...
            # nn.ReLU(inplace=True)  # In the original implementation no activation is used here
        )
    ...
    def forward(self, verts, feats):
        ...
        # Pooling
        # mx, _ = torch.max(x_feat, 2, keepdim=True)  # From https://github.com/fxia22/pointnet.pytorch
        # x = mx.view(-1, 1024)
