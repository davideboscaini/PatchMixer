...
from models_dgcnn import dgcnn_class
...
def parse_args():
    ...
    parser.add_argument('--k', type=int, default=16, help='Number of nearest neighbours')
...
def main():
    ...
    os.system('cp ../models_dgcnn.py {:s}/models_dgcnn_backup.py'.format(args.path_weights))
